...
public class buttonTesting1900 {
    ...
    public void test (){
        ...
        new WebDriverWait(driver, Duration.ofSeconds(10)).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[name()='svg']//*[name()='circle' and @id ='1900']")));
